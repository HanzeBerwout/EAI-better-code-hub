...
public enum Lijnen {
	...
	LIJN3 (new Stop(Halte.N,1),new Stop(Halte.O,1),new Stop(Halte.P,1),
			new Stop(Halte.K,-1),new Stop(Halte.Q,1),new Stop(Halte.R,1)),
	LIJN4 (new Stop(Halte.S,1),new Stop(Halte.T,1),new Stop(Halte.U,1),
			new Stop(Halte.V,1),new Stop(Halte.I,1),new Stop(Halte.K,1),new Stop(Halte.L,1),new Stop(Halte.M,1)),
	LIJN5 (new Stop(Halte.W,1),new Stop(Halte.X,1),new Stop(Halte.Y,1),new Stop(Halte.G,1),
			new Stop(Halte.Z,1),new Stop(Halte.N,1)),
	LIJN6 (new Stop(Halte.A,1),new Stop(Halte.B,1),new Stop(Halte.H,1),new Stop(Halte.T,-1),
